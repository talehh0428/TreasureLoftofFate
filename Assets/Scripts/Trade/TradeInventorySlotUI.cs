...
public class TradeInventorySlotUI : MonoBehaviour, IPointerClickHandler
{
    ...
    public event Action<TradeInventorySlotUI> Clicked;

    public TradeOfferStack CurrentStack => currentStack;
    public bool HasItem => currentStack.Definition != null;
    ...
    public void Setup(TradeOfferStack stack)
    {
        ...
        {
            quantityText.text = currentStack.WarehouseQuantity.ToString();
        }
